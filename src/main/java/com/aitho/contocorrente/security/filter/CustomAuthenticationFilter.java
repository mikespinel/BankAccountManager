...
import static com.aitho.contocorrente.util.CustomSecurityHeaders.ACCESS_TOKEN;
import static com.aitho.contocorrente.util.CustomSecurityHeaders.REFRESH_TOKEN;
...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        String refreshToken = (String) JwtUtil.createRefreshToken(user.getUsername()).get("refreshToken");
